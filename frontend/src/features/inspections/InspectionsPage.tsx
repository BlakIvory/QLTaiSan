    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="card p-4">
        <div className="relative w-full">
          ...
          <input type="text" placeholder="Tìm theo mã thiết bị, số tem kiểm định..." className="w-full pl-9 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm" />
        </div>
      </div>
